...
if __name__ == '__main__':
    ...
    net = PlainUSR_ultra(n_feat=32,im_feat=[32,16],attn_feat=4,scale=4)
    # net = PlainUSR_large(n_feat=80,im_feat=[80,64,48],attn_feat=16,scale=2)


    net.eval()
    net.load_state_dict(torch.load('/root/NTIRE/BasicSR/experiments/PlainUSR_ultra_x4_DIV2K_LSDIR_300k_B64G1_wandb/models/net_g_300000.pth')['params_ema'],True)
    ...
    net_rep = model_convert(net,'/root/NTIRE/BasicSR/experiments/PlainUSR_ultra_x4_DIV2K_LSDIR_300k_B64G1_wandb/models/net_g_inference.pth',False)
