...
class Conv3XC_inference(nn.Module):
    def __init__(self, c_in, c_out, gain1=1, gain2=0, s=1, bias=True, relu=False):
        super(Conv3XC_inference, self).__init__()
...
class SPAB(nn.Module):
    def __init__(self,
        ...
        self.c1_r = Conv3XC_inference(in_channels, mid_channels, gain1=2, s=1)
        self.c2_r = Conv3XC_inference(mid_channels, mid_channels, gain1=2, s=1)
        self.c3_r = Conv3XC_inference(mid_channels, out_channels, gain1=2, s=1)
...
class SPAN_inference(nn.Module):
    """
    ...
    def __init__(self,
        ...
        super(SPAN_inference, self).__init__()
        ...
        self.conv_1 = Conv3XC_inference(in_channels, feature_channels, gain1=2, s=1)
        ...
        self.conv_2 = Conv3XC_inference(feature_channels, feature_channels, gain1=2, s=1)
...
if __name__ == "__main__":
    ...
    import time
    model = SPAN_inference(3, 3, upscale=4, feature_channels=48).cuda()
    model.eval()
