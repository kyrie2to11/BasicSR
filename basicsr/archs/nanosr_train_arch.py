...
if __name__ == "__main__":
    ...
    # model weights path before convert
    net.load_state_dict(torch.load('/root/NTIRE/BasicSR/experiments/NanoSR_refactored_x4_gt128_DIV2K_LSDIR_500k_B64G1_wandb/models/net_g_500000.pth')['params_ema'],True) 

    img = Image.open(r'/root/NTIRE/BasicSR/datasets/DIV2K_LSDIR_valid/DIV2K_LSDIR_valid_LR/0000001x4.png').convert('RGB')
    x = transforms.ToTensor()(img)    
    x = x.unsqueeze(0)
    f = nn.L1Loss()

    # model weights path after convert
    net_rep = model_convert(net,'/root/NTIRE/BasicSR/experiments/NanoSR_refactored_x4_gt128_DIV2K_LSDIR_500k_B64G1_wandb/models/net_rep.pth',True)
