...
class PartialConv(nn.Module):
    ...
    def forward(self, inputs):
        ...
        # above numpy style slice operation leads to trace fault, detailed error is as follows:
        '''
...
class MPFD(nn.Module):
    def __init__(self, in_channels=16, dilation=1):
        ...
        self.refine_1 = nn.Conv2d(in_channels,
                                  ...
                                  kernel_size=1,
                                  stride=1,
                                  padding=dilation * (1 - 1) // 2) # fc layer
...
class FAN(nn.Module):
    def __init__(self, num_out_ch=3, scale=4, num_feat=32, num_blocks=4, dilation=1):
