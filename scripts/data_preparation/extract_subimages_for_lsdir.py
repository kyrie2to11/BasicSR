...
def main():
    ...
    # HR images
    opt['input_folder'] = 'datasets/LSDIR/HR/train'
    opt['save_folder'] = 'datasets/LSDIR/HR/train_sub'
    opt['crop_size'] = 480
    opt['step'] = 240
    opt['thresh_size'] = 0
    ...
    # LRx4 images
    opt['input_folder'] = 'datasets/LSDIR/X4/train'
    opt['save_folder'] = 'datasets/LSDIR/X4/train_sub'
    opt['crop_size'] = 120
    opt['step'] = 60
    opt['thresh_size'] = 0
    extract_subimages(opt)
